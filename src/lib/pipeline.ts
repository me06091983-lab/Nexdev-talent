export const PIPELINE_STATUSES = [
  { value: 'pipeline',    label: 'În recrutare', headerClass: 'bg-slate-100 border-slate-200 text-slate-700' },
  { value: 'submitted',   label: 'Propus client', headerClass: 'bg-blue-50 border-blue-200 text-blue-700' },
  { value: 'shortlisted', label: 'Selectat',      headerClass: 'bg-purple-50 border-purple-200 text-purple-700' },
  { value: 'interview',   label: 'Interviu',      headerClass: 'bg-amber-50 border-amber-200 text-amber-700' },
  { value: 'rejected',    label: 'Respins',       headerClass: 'bg-red-50 border-red-200 text-red-600' },
  { value: 'offer',       label: 'Ofertă',        headerClass: 'bg-green-50 border-green-200 text-green-700' },
] as const
